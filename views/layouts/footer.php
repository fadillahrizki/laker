...
<div id="footer-bar" class="footer-bar-5">
    ...
    <a href="<?=Url::to(['/'])?>" class="<?=isset($this->title) ? $this->title == "Home" ? 'active-nav' : '' : '' ?>"><i data-feather="home" data-feather-line="1" data-feather-size="21" data-feather-color="blue2-dark" data-feather-bg="blue2-fade-light"></i><span>Home</span></a>
    <a href="<?=Url::to(['/site/berita'])?>" class="<?=isset($this->title) ? $this->title == "Berita" ? 'active-nav' : '' : '' ?>"><i data-feather="file" data-feather-line="1" data-feather-size="21" data-feather-color="brown1-dark" data-feather-bg="brown1-fade-light"></i><span>Berita</span></a>
